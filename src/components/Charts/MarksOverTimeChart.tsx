...
export default function MarksOverTimeChart() {
  return (
    <div className="h-90 w-2/5 flex flex-col items-start justify-center rounded-xl border border-stroke bg-white px-5 py-6  dark:border-strokedark dark:bg-boxdark">
